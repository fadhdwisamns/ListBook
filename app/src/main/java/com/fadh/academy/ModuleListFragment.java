...
import com.fadh.academy.adapter.ModuleListAdapter;

import com.fadh.academy.adapter.MyAdapterClickListener;
import com.fadh.academy.data.ModuleEntity;
import com.fadh.academy.reader.CourseReaderCallback;
 ...
 */public class ModuleListFragment extends Fragment implements MyAdapterClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() != null) {
            ...
            populateRecyclerView(DataDumy.generateDummyModules("a14"));
        }
